...
window.AUTOPASS_TECHNICIAN_VERSION = 'v9-3-location-intelligence';
console.log('AUTOPASS technician.js V9.3 carregado');
...
const NEARBY_RADIUS_M = 3000; // V9.3: raio temporário de produção; alvo futuro 1 km
