                ...
                with zipfile.ZipFile(io.BytesIO(raw)) as z:
                    ...
                    for msg in messages:
                        ...
                        if station:
                            ...
                            for eq in _wa_equipment_rows(msg["text"]):
                                duplicate = False
                                duplicate_info = ""
                                if loc:
                                    found = (
                            ...
                            # mídias imediatamente seguintes ficam associadas à última visita
                            current_visit["attachments"].extend(a for a in attachments if a not in current_visit["attachments"])
