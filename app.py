...
@app.get("/dashboard/pos")
@dashboard_required
def pos_dashboard_page():
    return redirect("/gerencial?view=pos-inventory")

@app.get("/dashboard/validador-tdi")
@dashboard_required
def validator_tdi_dashboard_page():
    return redirect("/gerencial?view=validator-tdi-inventory")

@app.get("/dashboard/bloqueio")
@dashboard_required
def block_dashboard_page():
    return redirect("/gerencial?view=block-inventory")
